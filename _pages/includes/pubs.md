...
- `AISTATS 2024` [A Neural Architecture Predictor based on GNN-Enhanced Transformer](https://proceedings.mlr.press/v238/xiang24a.html), Xunzhi Xiang, **Kun Jing**, Jungang Xu.
- `Neural Networks 2023` [An architecture entropy regularizer for differentiable neural architecture search](https://www.sciencedirect.com/science/article/pii/S0893608022004567), **Kun Jing**, Luoyu Chen, Jungang Xu.
- `IJCNN 2022` [A Graph Architecture Search Method Based On Grouped Operations](https://ieeexplore.ieee.org/abstract/document/9892900/), Luoyu Chen, Jungang Xu, **Kun Jing**, Yingfei Sun.
- `IJCAI 2022` [Graph Masked Autoencoder Enhanced Predictor for Neural Architecture Search](https://www.ijcai.org/proceedings/2022/432), **Kun Jing**, Jungang Xu, Pengfei Li.
- `Neurocomputing 2022` [A neural architecture generator for efficient search space](https://www.sciencedirect.com/science/article/pii/S0925231221016994), **Kun Jing**, Jungang Xu, Zhen Zhang.
- `IJCNN 2020` [NASABN: A Neural Architecture Search Framework for Attention-Based Networks](https://ieeexplore.ieee.org/abstract/document/9207600), **Kun Jing**, Jungang Xu, Hui Xu.
- `arXiv 2019` [A Survey on Neural Network Language Models](https://arxiv.org/abs/1906.03591), **Kun Jing**, Jungang Xu.
